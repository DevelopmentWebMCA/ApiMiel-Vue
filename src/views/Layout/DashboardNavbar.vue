<template>
  ...
  >
  <!-- Navbar links -->
    <b-navbar-nav class="align-items-right">
    ...
    <b-navbar-nav class="align-items-left ml-auto ml-md-0">
        ...
        <a href="#" class="nav-link pr-0" @click.prevent slot="title-container">
          <b-media no-body class="align-items-center">
            ...
            <b-media-body class="ml-2 d-none d-lg-block">
              <span class="mb-0 text-sm  font-weight-bold">Cristhian Enrique Olivares Lara</span>
            </b-media-body>
          </b-media>
        </a>
